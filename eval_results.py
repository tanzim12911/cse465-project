"""Evaluation report for the Color Illusion pipeline."""
...
def analyze_records(records: List[Dict[str, Any]]) -> Dict[str, Any]:
    """Calculate overall and Color Illusion subtype accuracy."""
    if not records:
        return {}
    ...
    for r in records:
        ...
        if any(k in q for k in ["uniform", "horizontal bar", "diagonal lines"]):
            pat = "Uniformity"
        elif any(k in q for k in ["darkest", "lightest", "brightest"]):
            pat = "Ranking"
        else:
            pat = "Comparison"
...
def compare_baseline_vs_ace(results_dir: str = "./results"):
    """Compare baseline and adaptive Color Illusion results on held-out splits."""
    ...
    print("\n" + "=" * 78)
    print("CSE465 REPORT: BASELINE vs. ADAPTIVE COLOR ILLUSION")
    print("=" * 78)
